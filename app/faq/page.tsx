...
const GENERAL: QA[] = [
  {
    ...
    a: "The College Flag Showcase Series is a girls national recruiting series — a verified combine plus a college showcase tournament in one weekend, evaluated in person by college flag football coaches. The series runs ten events across the 2026–27 season, coast to coast.",
  },
  {
