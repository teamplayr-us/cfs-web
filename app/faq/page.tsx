...
const GENERAL: QA[] = [
  {
    ...
    a: "The College Flag Showcase Series is a girls national recruiting series. Each event includes a verified combine plus a college showcase tournament in one weekend, evaluated in person by college flag football coaches. The series runs ten events across the 2026–27 season, coast to coast.",
  },
  {
  ...
  },
  {
    ...
    a: "Dallas — December 11–13, 2026, at Craig Ranch Sports Complex in McKinney. Combine day is Friday, December 11, from 3:00 to 5:30 PM; the tournament runs Saturday–Sunday. Registration closes November 22.",
  },
  {
    q: "Is college flag football actually real?",
    a: "Very. Flag football debuts at the 2028 Olympics in LA, it's an NCAA Emerging Sport for Women with scholarships live today, Nebraska becomes the first Power Four school with varsity flag beginning spring 2027, and 90+ college programs are playing with more added every season.",
  },
  {
