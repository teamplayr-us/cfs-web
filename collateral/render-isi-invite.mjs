...
//   node collateral/render-isi-invite.mjs "Org Name" public/programs/logo.png "City, ST" "Team 14U|Team 16U"
//
// Args:
...
if (!orgName || !logoPath || !location || !teams) {
  console.error(
    'Usage: node render-isi-invite.mjs "Org Name" public/programs/logo.png "City, ST" "Team 14U|Team 16U" ["Event line"] ["Venue line"] [out.png]',
  );
  process.exit(1);
}
...
const tmp = join(here, ".invite-org-isi.tmp.html");
writeFileSync(tmp, html);

const out = join(
  here,
  outFile ||
    `invite-isi-${basename(logoPath).replace(/\.(png|jpg|jpeg)$/i, "")}.png`,
);
